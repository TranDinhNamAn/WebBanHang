    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a href="#" class="nav-link">Cá nhân</a>
          <ul class="dr-menu">
            <li class="subb"><a href="cart.jsp"><p style="margin-top: 6px"
    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
        <p class="breadcrumbs"><span class="mr-2"><a href="trangchu">Trang chủ <i
          ...
          <span><a href="changepass">Đổi mật khẩu <i class="ion-ios-arrow-forward"></i></a></span></p>
  ...
  <div class="container">
    <div class="mb-5 contact-info">
      <div class="col-md-88 block-9 mb-md-5">
        <form action="changepass" method="post" class="bg-light p-5 contact-form">
          <h1>Đổi mật khẩu</h1>
          <% String error = (String) request.getAttribute("Error");%>
          <p style="color: red;text-align: center"><%= error != null ? error : ""%>
          </p>
          <div class="form-group">
            <input type="password" class="form-control" placeholder="Mật khẩu cũ" id="pass" name="pass">
            <% String error1 = (String) request.getAttribute("Error1");%>
            <p style="color: red;text-align: center"><%= error1 != null ? error1 : ""%>
          ...
          <div class="form-group">
            <input type="password" class="form-control" placeholder="Nhập lại mật khẩu mới" id="repass" name="repass">
            <span class="icon icon-lock u"></span>
          </div>
          <div class="form-group">
            <input type="submit" value="Đổi mật khẩu" id="button" class="btn btn-primary py-3 px-5">
          </div>
        </form>
      </div>
    </div>
