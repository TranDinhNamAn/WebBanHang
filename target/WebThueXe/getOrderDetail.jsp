...
<%@ page import="vn.edu.hcmuaf.fit.model.OrderDetail" %>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="trangchu">Trang chủ <i
                    ...
                    <span><a href="#">Đơn hàng<i class="ion-ios-arrow-forward"></i></a></span></p>
                <%List<OrderDetail> list = (List<OrderDetail>) request.getAttribute("list");%>
                <h1 class="mb-3 bread">Đơn hàng <%=request.getAttribute("id")%></h1>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col col-md-12">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-right" ><%=detail.getPrice()%></td>
                    </tr>
                    <%}%>
                    </tbody>
                </table>
