    ...
    <div class="container">
        <div class="mb-5 contact-info">
            ...
            <div class="col-md-88 block-9 mb-md-5">
                <form action="reset" method="post" class="bg-light p-5 contact-form">
                    <h1>Quên mật khẩu</h1>
                    <% String error = (String) request.getAttribute("Error");%>
                    <% String email = request.getParameter("email");%>
                    <p style="color: red;text-align: center"><%= error!=null ? error:""%> </p>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Nhập Email" id="email" name="email" value="<%=email!=null? email:""%>">
                        <span class="icon icon-envelope u"></span>
                    </div>

                    <div class="form-group">
                        <input type="submit" value="Gửi mã xác nhận" id="button" class="btn btn-primary py-3 px-5">
                    </div>
                </form>
            </div>
        </div>
