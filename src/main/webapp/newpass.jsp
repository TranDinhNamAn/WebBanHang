    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
        <p class="breadcrumbs"><span class="mr-2"><a href="trangchu">Trang chủ <i
          ...
          <span><a href="reset">Quên mật khẩu <i class="ion-ios-arrow-forward"></i></a></span></p>
        <h1 class="mb-3 bread">Lấy lại mật khẩu</h1>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="mb-5 contact-info">
      <div class="col-md-88 block-9 mb-md-5">
        <form action="newpass" method="post" class="bg-light p-5 contact-form">
          <h1>Quên mật khẩu</h1>
          <% String error = (String) request.getAttribute("Error");%>
          <p style="color: red;text-align: center"><%= error != null ? error : ""%>
          </p>
          <div class="form-group">
            <input type="password" class="form-control" placeholder="Mật khẩu mới" id="pass" name="pass"
                   >
          ...
          <div class="form-group">
            <input type="submit" value="Xác nhận" id="button" class="btn btn-primary py-3 px-5">
          </div>
        </form>
      </div>
    </div>
